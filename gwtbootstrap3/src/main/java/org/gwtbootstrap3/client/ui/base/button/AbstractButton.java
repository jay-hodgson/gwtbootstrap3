...
public abstract class AbstractButton extends ComplexWidget
          implements HasEnabled, HasActive, HasType<ButtonType>, HasSize<ButtonSize>, HasDataTarget, HasClickHandlers,
          Focusable, HasAllMouseHandlers, HasTargetHistoryToken, HasHref, HasText {
     ...
     private String originalText, targetHistoryToken;
      ...
      * <p/>
      * If button is inside a {@link org.gwtbootstrap3.client.ui.Modal} and
      * dismiss type is {@code MODAL} the button will act as the dismiss (close)
      * button for this Modal. Same goes for
      * {@link org.gwtbootstrap3.client.ui.Alert} and dismiss type {@code ALERT}.
      *
      * @param dismiss
     ...
     /**
      * Attempt to capture the original text before setting the data loading
      * text.
      */
