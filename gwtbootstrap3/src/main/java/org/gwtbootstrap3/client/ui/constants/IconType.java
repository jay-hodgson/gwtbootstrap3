...
public enum IconType implements Type, Style.HasCssName {
    ...
    _500PX("fa-500px"),
    SYN_CHEVRON_DOWN("syn-icon-chevron_down"),
    SYN_CHEVRON_UP("syn-icon-chevron_up"),
    SYN_CLOSE("syn-icon-close"),
    SYN_CREATE_FOLDER("syn-icon-create_folder"),
    SYN_DB("syn-icon-db"),
    SYN_DELETE("syn-icon-delete"),
    SYN_DOWNLOAD("syn-icon-download"),
    SYN_FILE("syn-icon-file"),
    SYN_HELP("syn-icon-help"),
    SYN_INFO("syn-icon-info"),
    SYN_LOADING("syn-icon-loading"),
    SYN_MENU("syn-icon-menu"),
    SYN_NO_ACCESS("syn-icon-no_access"),
    SYN_SEARCH("syn-icon-search"),
    SYN_SORT("syn-icon-sort"),
    SYN_STAR("syn-icon-star"),
    SYN_STAR_OUTLINE("syn-icon-star_outline"),
    SYN_SUCCESS_CHECKMARK("syn-icon-success_checkmark"),
    SYN_SUCCESS_CIRCLE("syn-icon-sucess_circle"),
    SYN_LOGO("syn-icon-synapse_logo"),
    SYN_TEST("syn-icon-test"),
    SYN_TIMER("syn-icon-timer"),
    SYN_UNLOCKED("syn-icon-unlocked"),
    SYN_WARNING("syn-icon-warning")
    ;
